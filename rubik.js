    ...
    methods:{
        abajoDer(){
            ...
            let elementosMovidos = [
                this.cubo.bottom[0],this.cubo.bottom[1],this.cubo.bottom[2],this.cubo.bottom[3],this.cubo.bottom[4],this.cubo.bottom[5],this.cubo.bottom[6],this.cubo.bottom[7],this.cubo.bottom[8]
            ]
            ...
            this.cubo.bottom = [
                this.cubo.bottom[0],this.cubo.bottom[1],this.cubo.bottom[2],this.cubo.bottom[3],this.cubo.bottom[4],this.cubo.bottom[5],this.cubo.bottom[6],this.cubo.bottom[7],this.cubo.bottom[8]] = [elementosMovidos[6], elementosMovidos[3],elementosMovidos[0],elementosMovidos[7],elementosMovidos[4],elementosMovidos[1],elementosMovidos[8],elementosMovidos[5],elementosMovidos[2]
            ]
        ...
        abajoIzq(){
            ...
            this.cubo.detras = newDetras
            this.cubo.bottom = [
                this.cubo.bottom[0],this.cubo.bottom[1],this.cubo.bottom[2],this.cubo.bottom[3],this.cubo.bottom[4],this.cubo.bottom[5],this.cubo.bottom[6],this.cubo.bottom[7],this.cubo.bottom[8]] = [elementosMovidos[2], elementosMovidos[5],elementosMovidos[8],elementosMovidos[1],elementosMovidos[4],elementosMovidos[7],elementosMovidos[0],elementosMovidos[3],elementosMovidos[6]
            ]
        },
        arribaIzq(){
            ...
            let elementosMovidos = [
                this.cubo.top[0],this.cubo.top[1],this.cubo.top[2],this.cubo.top[3],this.cubo.top[4],this.cubo.top[5],this.cubo.top[6],this.cubo.top[7],this.cubo.top[8]
            ]
            ...
            this.cubo.detras = newDetras
            this.cubo.top = [
                this.cubo.top[0],this.cubo.top[1],this.cubo.top[2],this.cubo.top[3],this.cubo.top[4],this.cubo.top[5],this.cubo.top[6],this.cubo.top[7],this.cubo.top[8]] = [elementosMovidos[6], elementosMovidos[3],elementosMovidos[0],elementosMovidos[7],elementosMovidos[4],elementosMovidos[1],elementosMovidos[8],elementosMovidos[5],elementosMovidos[2]
            ]
        },
        arribaDer(){
            ...
            this.cubo.detras = newDetras
            this.cubo.top= [
                this.cubo.top[0],this.cubo.top[1],this.cubo.top[2],this.cubo.top[3],this.cubo.top[4],this.cubo.top[5],this.cubo.top[6],this.cubo.top[7],this.cubo.top[8]] = [elementosMovidos[2], elementosMovidos[5],elementosMovidos[8],elementosMovidos[1],elementosMovidos[4],elementosMovidos[7],elementosMovidos[0],elementosMovidos[3],elementosMovidos[6]
            ]
        },
        lateralDerechoAbajo(){
            ...
            let elementosMovidos = [
                this.cubo.lateralDer[0],this.cubo.lateralDer[1],this.cubo.lateralDer[2],this.cubo.lateralDer[3],this.cubo.lateralDer[4],this.cubo.lateralDer[5],this.cubo.lateralDer[6],this.cubo.lateralDer[7],this.cubo.lateralDer[8]
            ]
        ...
        lateralIzquierdoAbajo(){
            ...
            let elementosMovidos = [
                this.cubo.lateralIzq[0],this.cubo.lateralIzq[1],this.cubo.lateralIzq[2],this.cubo.lateralIzq[3],this.cubo.lateralIzq[4],this.cubo.lateralIzq[5],this.cubo.lateralIzq[6],this.cubo.lateralIzq[7],this.cubo.lateralIzq[8]
            ]
            ...
            this.cubo.lateralIzq= [
                this.cubo.lateralIzq[0],this.cubo.lateralIzq[1],this.cubo.lateralIzq[2],this.cubo.lateralIzq[3],this.cubo.lateralIzq[4],this.cubo.lateralIzq[5],this.cubo.lateralIzq[6],this.cubo.lateralIzq[7],this.cubo.lateralIzq[8]] = [elementosMovidos[6], elementosMovidos[3],elementosMovidos[0],elementosMovidos[7],elementosMovidos[4],elementosMovidos[1],elementosMovidos[8],elementosMovidos[5],elementosMovidos[2]
            ]
        },
        lateralIzquierdoArriba(){
            ...
            this.cubo.lateralIzq= [
                this.cubo.lateralIzq[0],this.cubo.lateralIzq[1],this.cubo.lateralIzq[2],this.cubo.lateralIzq[3],this.cubo.lateralIzq[4],this.cubo.lateralIzq[5],this.cubo.lateralIzq[6],this.cubo.lateralIzq[7],this.cubo.lateralIzq[8]] = [elementosMovidos[2], elementosMovidos[5],elementosMovidos[8],elementosMovidos[1],elementosMovidos[4],elementosMovidos[7],elementosMovidos[0],elementosMovidos[3],elementosMovidos[6]
            ]
        }
    }
})
